  ...
  <div class="row">
    <div class="col-sm-5">
          ...
          <select name="a_history" class="form-control">
            ...
            <?php if (count($get_details)): ?>
              <?php foreach ($get_details as $details): ?>
                <option value=<?php echo $details->de_name; ?><?php echo set_select('a_history', $details->de_name); ?>>
                  <?php echo $details->de_name; ?></option>
              <?php endforeach; ?>
            <?php endif; ?>
          </select>
          <div class="text-danger text-center">
            <?php echo form_error('a_history'); ?>
          </div>
        </div><br>
      </div>
      ...
      <div style="margin-bottom:1px;">
        ...
        <div class="text-danger text-center">
          <?php echo form_error('a_physician'); ?>
        </div>
      </div><br>
    ...
    <div class="col-sm-6">
      ...
      <div style="margin-bottom:17px;">
        ...
        <div class="row"><!--Begin First Column -->
          ...
          <div class="col-sm-4">
            ...
            <input class="form-control" type="text" name="a_pulse" value="<?php echo set_value('a_pulse'); ?>"
              placeholder="PR">
          </div>
        ...
        <div class="row"><!--Begin Second Column -->
          <div class="col-sm-4">
            ...
            <input class="form-control" type="text" name="a_temp" value="<?php echo set_value('a_temp'); ?>"
              placeholder="in C">
          </div>
          <div class="col-sm-4">
      ...
      <div style="margin-top:10px; margin-left: 2px" class="row">
        <table class="dataTable">
          <tr>
            <th class="inTable">Weight </th>
            <th class="inTable">Height </th>
            <th class="inTable">Pulse </th>
            <th class="inTable">Temperature </th>
            <th class="inTable">BMI </th>
          </tr>
          <?php
          $conn = mysqli_connect("localhost", "root", "", "patientrecord");
          $sql = "SELECT * FROM devicedata";
          $result = $conn->query($sql);

          if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
              echo "<tr><td style='padding-left: 12px'>" . $row["weight"] . "</td><td style='padding-left: 12px'>" . $row["height"] . "</td><td style='padding-left: 12px'>" . $row["pulseRate"] . "</td><td style='padding-left: 12px'>" . $row["temperature"] . "</td><td style='padding-left: 12px'>" . $row["bmi"] . "</td><tr>";
            }
          } else {
            echo "No Results";
          }
